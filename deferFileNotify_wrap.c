...
#define SWIG_init    Init_deferFileNotify
#define SWIG_name    "DeferFileNotify"

static VALUE mDeferFileNotify;
...
SWIGINTERN VALUE
_wrap_watch(int argc, VALUE *argv, VALUE self) {
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  int val3 ;
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "int","watch", 3, argv[2] ));
  } 
  arg3 = (int)(val3);
...
SWIGINTERN VALUE
_wrap_deferNanoSec(int argc, VALUE *argv, VALUE self) {
...
static swig_type_info _swigt__p_f_p_void__void = {"_p_f_p_void__void", "void (*)(void *)|callback_t", 0, 0, (void*)0, 0};
...
extern "C"
#endif
SWIGEXPORT void Init_deferFileNotify(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mDeferFileNotify = rb_define_module("DeferFileNotify");
  ...
  rb_define_module_function(mDeferFileNotify, "watch", _wrap_watch, -1);
  rb_define_module_function(mDeferFileNotify, "deferNanoSec", _wrap_deferNanoSec, -1);
  rb_define_module_function(mDeferFileNotify, "stop", _wrap_stop, -1);
}
